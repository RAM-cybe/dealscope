...
REQUIRED_COMPANY_COLUMNS = [
    ...
    "trailing_pe",
    "data_pull_date",
    # Piotroski F-score annual-history inputs (merged from the financial-health round)
    "net_income_fy0",
    "net_income_fy1",
    "operating_cash_flow_fy0",
    "operating_cash_flow_fy1",
    "total_assets_fy0",
    "total_assets_fy1",
    "long_term_debt_fy0",
    "long_term_debt_fy1",
    "current_assets_fy0",
    "current_liabilities_fy0",
    "current_assets_fy1",
    "current_liabilities_fy1",
    "total_revenue_fy0",
    "cost_of_revenue_fy0",
    "total_revenue_fy1",
    "cost_of_revenue_fy1",
    "shares_outstanding_fy0",
    "shares_outstanding_fy1",
]
